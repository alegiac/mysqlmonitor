...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            ?>
                d1.push([{{$str_time}}, {{array_sum($stats[$ky]['records'])}}]);
                d2.push([{{$str_time}}, {{array_sum($stats[$ky]['size'])/1024/1024}}]);
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($tables as $tb => $ky)
                            <tr>
                                <th> <i class="fa fa-table"></i> {{$tb}}</th>
                                <td><span class="sparkline_line">{{implode(',',$tb_h[$tb]['records'])}}</span></td>
                                <td> <span class="sparkline_bar">{{implode(',',$tb_h[$tb]['size'])}}</span></td>
