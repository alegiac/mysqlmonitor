...
@section('script')
    ...
    <script>
        ...
        gauge_option.series[0].data[0].value = '{{$simple_stats['pct_max_used_memory']}}';
        ...
        gauge_option.series[0].data[0].value = '{{$simple_stats['pct_slow_queries']}}';
        ...
        gauge_option.series[0].data[0].value = '{{$simple_stats['pct_connections_used']}}';
        ...
        gauge_option.series[0].data[0].value = '{{$simple_stats['pct_connections_aborted']}}';
            ...
            <div class="row top_tiles">
                ...
                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="tile-stats">
                        ...
                        <div class="count">{{\App\Classes\Helpers::format_size($db_size[0]->total)}}</div>
                        <h3>Database Size</h3>
                        <p>Database : <b>{{env('DB_DATABASE')}}</b></p>
                    </div>
                </div>
                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="tile-stats">
                        <div class="icon"><i class="fa fa-dot-circle-o"></i></div>
                        <div class="count">{{\App\Classes\Helpers::format_size($db_size[0]->free)}}</div>
                        <h3>Free Size</h3>
                        <p><b>{{env('DB_DATABASE')}}</b> Free Database Size</p>
                    </div>
                </div>
                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="tile-stats">
                        <div class="icon"><i class="fa fa-table"></i></div>
                        <div class="count">{{$count_tables[0]->count_tables}}</div>
                        <h3>Tables</h3>
                        <p><b>{{env('DB_DATABASE')}}</b> Total Tables</p>
                    </div>
                </div>
            </div>
